...
Input Format: First line: Integer n (number of buildings)

Second line: n space-separated integers: net energy for each building

Output Format: A single integer: Maximum net energy collectable from a contiguous block (wrapping allowed)
...
<img width="405" height="229" alt="m14-t1op" src="https://github.com/user-attachments/assets/a7d5f0de-b9b5-4748-acfc-d6e2de16340f" />

## Result:
Thus, the program successfully Implemented and the output is verified. 
